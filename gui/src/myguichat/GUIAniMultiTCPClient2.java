	...
	GUIAniMultiTCPClient2() {// コンストラクター
		...
		while (true) {
			try {
				...
				System.out.println("終了時はend");
				System.out.println("位置変更はface,place,0~2,100,200");
				System.out.println("色変更はface,color,0~2,yellow");
				System.out.println("顔変更はface,emotion,0~2,[normal/smile/angry]");
				System.out.println(":");
