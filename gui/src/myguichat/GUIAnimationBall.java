...
class GUIAnimationBall {
	...
	void draw(Graphics g) {
		...
		//fobj.makeFace(g);
		int emonum = 0;
		if(emotion.equals("normal")) emonum=0;
		else if(emotion.equals("smile")) emonum=1;
		else if(emotion.equals("angry")) emonum=2;
		facelook.makeFace(g, Color.DARK_GRAY, Color.CYAN, emonum);
